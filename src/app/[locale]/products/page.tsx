...
const PRODUCTS = [
    { id: 1, name: "Klasik Odunlu Şömine", category: "wood", price: "25.000 TL", image: "https://images.unsplash.com/photo-1510672981848-a1c4f1cb5ccf?auto=format&fit=crop&q=80" },
    { id: 2, name: "Modern Etanollü Model", category: "ethanol", price: "18.500 TL", image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&q=80" },
    { id: 3, name: "Panoramik Elektrikli", category: "electric", price: "12.000 TL", image: "https://images.unsplash.com/photo-1560185007-cde436f6a4d0?auto=format&fit=crop&q=80" },
    ...
    { id: 5, name: "Masaüstü Etanollü", category: "ethanol", price: "4.500 TL", image: "https://images.unsplash.com/photo-1615873968403-89e068629265?auto=format&fit=crop&q=80" },
                    ...
                    <aside className="w-full md:w-64 space-y-6">
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><Button variant="ghost" className="w-full justify-start">{t('allProducts')}</Button></li>
                                <li><Button variant="ghost" className="w-full justify-start">{t('wood')}</Button></li>
                                <li><Button variant="ghost" className="w-full justify-start">{t('ethanol')}</Button></li>
                                <li><Button variant="ghost" className="w-full justify-start">{t('electric')}</Button></li>
                            </ul>
                        </div>
                    </aside>
